    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          "triagem-tecnica": "hsl(var(--status-triagem-tecnica))",
          pdd: "hsl(var(--status-pdd))",
          desenvolvimento: "hsl(var(--status-desenvolvimento))",
          homologacao: "hsl(var(--status-homologacao))",
          golive: "hsl(var(--status-golive))",
